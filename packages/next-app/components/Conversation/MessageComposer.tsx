  ...
  const onTransfer = async () => {
    try {
      ...
      const nxtpConfig: NxtpSdkConfig = {
        ...
        chains: {
          "1735353714": {
              providers: [process.env.GOERLI_RPC_URL as string],
              assets: [
              {
                  name: "TEST",
                  symbol: "TEST",
          ...
          "1735356532": {
              providers: [process.env.OPTIMISM_GOERLI_RPC_URL as string],
              assets: [
              {
                  name: "TEST",
                  symbol: "TEST",
      ...
      if (await window?.ethereum?.request({ method: 'eth_chainId' }) != '0x5') {
