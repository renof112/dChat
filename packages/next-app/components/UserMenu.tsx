    ...
    <>
      <div>
        <div className="flex items-center">
          ...
          <p className="text-sm font-bold text-white">You are not connected.</p>
        </div>

        <a onClick={onConnect}>
          <p className="text-sm font-normal text-white hover:text-y-200 ml-3 cursor-pointer">
